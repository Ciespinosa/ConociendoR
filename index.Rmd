...
Podemos usar la función __sink__ para redireccionar la salida a un archivo .txt, de esta forma, R ya no imprimirá en la consola sino que lo hará en el documento que hemos generado. Debemos volver a correr la función __sink__ para que se cierre la conexión con el archivo. Recuerden siempre cerrar esta función caso contrario todo lo que hagan se imprimirá en este archivo.
...
Podríamos generar un reporte con los datos utilizando la función __sink__. De esta forma, procesaremos los datos de edad y género que tenemos y los imprimiremos en un txt llamado reporte1.
...
Aunque la función __sink__, puede ser util para guardar rápidamente resultados por ejemplo de análisis estadísticos, no es una buena opción para guardar tablas de datos. Para guardar  tablas es mejor usar la función __write.csv__. Veamos un ejemplo.
